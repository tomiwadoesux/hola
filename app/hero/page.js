...
export default function Hero() {
  return (
    <div className="h-[100vh] w-[100vw]">
      <div className="flex  relative gap-3 pl-7   pt-7 w-[40%] flex-row">
        <h5 className="text-[10px] text-center  text-black md:text-sm text-xs">
          Polaroids
        </h5>
        <h5 className="text-[10px] text-center text-black md:text-sm text-xs">
          Photos
      ...
      <div className=" fixed flex flex-col gap-1 md:flex-col justify-between text-black right-7 top-14 md:top-7 ">
        <a
          href="mailto:Olaoluwaakinwale89@gmail.com"
          className="text-base  text-black "
        >
          <h5 className="text-xs md:text-sm text-left   text-black underline underline-offset-3">
      ...
      <div className="flex  flex-col absolute left-5 md:left-10 top-32 md:top-24 gap-3 md:gap-1  w-[85%] md:w-[85%] lg:w-[40%]">
        <div className="flex flex-col ">
          <div className="flex flex-col">
            <h1 className="  text-left text-7xl md:text-9xl text-black lg:text-9xl">
              ÀKÍNWÁLÉ
            </h1>
          </div>
          <div className=" self-end pt-1">
            <h1 className="  text-right text-7xl md:text-9xl text-black lg:text-9xl">
              ỌLÀÓLÚWÀ
            </h1>
          </div>
        ...
        <div className=" lg:hidden">
          <div className="flex pt-8 flex-row-reverse gap-4">
            <div className="  aspect-[2/3] w-[60%] md:w-[40%] bg-black ">
              <Image
                src="/images/67.webp"
                alt="Hmm"
                width={800}
        ...
        <div className="">
          <div className="flex flex-row justify-between pt-0 md:pt-3">
            <div className="text-left flex flex-col  pt-5 text-black ">
              <h5 className="text-base md:text-lg">Height: 6&apos;2</h5>
              <h5 className="text-base md:text-lg">Waist: 32</h5>
              <h5 className="text-base md:text-lg">Chest: 40</h5>
              <h5 className="text-base md:text-lg">Leg: 32</h5>
              <h5 className="text-base md:text-lg">Eye Color: Fair</h5>
              <h5 className="text-base md:text-lg">Hair Color: Fair</h5>
              <h5 className="text-base md:text-lg">Shoe Size: Fair</h5>
            </div>
            <div className="text-left flex flex-col  pt-5 text-black ">
              <h5 className="text-base md:text-lg">Editorial</h5>
              <h5 className="text-base md:text-lg">Commercial</h5>
              <h5 className="text-base md:text-lg">Runway</h5>
      ...
      <div className=" absolute fixed left-5 md:left-10 bottom-0 md:bottom-4 gap-3 md:gap-1">
        <h5 className="text-xs text-right md:text-left text-black">
          ® 2025 All Rights Reserved
        </h5>
      </div>
      <div className="hidden lg:block">
        <div className="flex absolute bottom-64 md:bottom-4 right-7 flex-row-reverse gap-4">
